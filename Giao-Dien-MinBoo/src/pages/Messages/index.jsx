                ...
                <div className="flex-1 overflow-y-auto">
                    ...
                    {conversations.map((conv) => (
                        <button key={conv.conversation_id}
                            ...
                            className={`w-full flex items-center gap-3 px-5 py-3 hover:bg-gray-50 transition-colors ${activeConv?.conversation_id === conv.conversation_id ? "bg-gray-50" : ""
                                }`}>
                            ...
                            return (
                                <div key={msg.message_id} className={`flex gap-2 ${isMine ? "flex-row-reverse" : ""}`}>
                                    ...
                                    <div className={`max-w-xs ${isMine ? "items-end" : "items-start"} flex flex-col`}>
                                        ...
                                        {msg.content && (
                                            <div className={`px-4 py-2 rounded-3xl text-sm ${isMine
