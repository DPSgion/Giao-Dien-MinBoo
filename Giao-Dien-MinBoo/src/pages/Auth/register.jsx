        ...
        <div className="flex flex-col items-center justify-center min-h-screen bg-gray-50">
            <div className="w-full max-w-[350px] bg-white border border-gray-300 p-10 flex flex-col items-center mb-4">
                ...
                <button className="w-full bg-[#0095f6] text-white font-semibold py-1.5 rounded-lg mb-6 text-sm flex items-center justify-center gap-2">
                    <span className="bg-white text-[#0095f6] rounded-sm w-4 h-4 flex items-center justify-center text-[10px]">f</span>
                ...
                <form onSubmit={handleSubmit} className="w-full flex flex-col gap-2">
                    ...
                    <p className="text-center text-[10px] text-gray-500 mt-2">
                        People who use our service may have uploaded your contact information to MinBOO. <Link to="#" className="text-blue-900">Learn More</Link>
                    </p>
