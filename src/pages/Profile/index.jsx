        ...
        <div className="flex-shrink-0">
          <div className="relative">
            <div className="w-36 h-36 rounded-full bg-gradient-to-tr from-yellow-400 via-red-500 to-purple-600 p-0.5">
              <img
                src={profile.avatar || `https://ui-avatars.com/api/?name=${profile.name}&background=random&size=200`}
      ...
      <div className="border-t border-gray-200">
        <div className="flex justify-center gap-14">
          <button
            ...
            className={`flex items-center gap-2 py-4 text-xs font-semibold tracking-widest border-t-2 transition-colors ${
